...
def main():
    ...
    tables = [Table("patients", "patients.csv", pks=["patientID"]),
              ...
              Table("staffPatients", "staffpatients.csv", fks=[["staffID"], ["patientID"]],
                    ref_tables=["staff", "patients"], refs=[["staffID"], ["patientID"]]),
              Table("admissions", "admissions.csv", pks=["patientID"], fks=[["patientID"]], ref_tables=["patients"],
                    refs=[["patientID"]])]
